...
export function EmptyState({ glyph = 'inbox', title, description, action, secondaryAction, align = 'center', className = '', ...rest }) {
  return (
    <div className={['lamp-empty', align === 'left' && 'lamp-empty--left', className].filter(Boolean).join(' ')} {...rest}>
