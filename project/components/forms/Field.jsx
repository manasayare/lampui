...
export const Field = /* @__PURE__ */ Object.assign(/* @__PURE__ */ React.forwardRef(function Field({ label, htmlFor, description, helper, error, warning, success, required = false, optional = false, count, layout = 'stack', children, className = '', ...rest }, ref) {
  ...
  return (
    <div ref={ref} className={['lamp-field', layout === 'row' && 'lamp-field--row', className].filter(Boolean).join(' ')} {...rest}>
      {label ? (
