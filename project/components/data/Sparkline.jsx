...
export const Sparkline = /* @__PURE__ */ Object.assign(/* @__PURE__ */ React.forwardRef(function Sparkline({ data = [], width = 96, height = 24, color = 'var(--chart-primary)', variant = 'line', area = true, baseline, className = '', ...rest }, ref) {
  ...
  return (
    <svg ref={ref} width={width} height={height} className={className} role="img" aria-hidden="true" {...rest}>
